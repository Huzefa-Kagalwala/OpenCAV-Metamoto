...
"""autogenerated by genpy from ros_sut/RadarTrackArray.msg. Do not edit."""
import sys
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','ros_sut/RadarTrack[]']
