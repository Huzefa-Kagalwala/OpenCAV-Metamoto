...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MrrHeaderSensorCoverage>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'can_doppler_coverage)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MrrHeaderSensorCoverage>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'can_doppler_coverage)) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MrrHeaderSensorCoverage>)))
  ...
  "103e1cc4a1419555076bebeb40db9042")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MrrHeaderSensorCoverage)))
  "Returns md5sum for a message object of type 'MrrHeaderSensorCoverage"
  "103e1cc4a1419555076bebeb40db9042")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MrrHeaderSensorCoverage>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%uint8 can_sensor_fov_hor~%uint8 can_doppler_coverage~%uint8 can_range_coverage~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MrrHeaderSensorCoverage)))
  "Returns full string definition for message of type 'MrrHeaderSensorCoverage"
  (cl:format cl:nil "std_msgs/Header header~%~%uint8 can_sensor_fov_hor~%uint8 can_doppler_coverage~%uint8 can_range_coverage~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
