...
(cl:defclass <EsrStatus2> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (canmsg
    ...
    :initform "")
   (rolling_count2
    :reader rolling_count2
    :initarg :rolling_count2
    :type cl:fixnum
    :initform 0)
   (max_track_ack
    :reader max_track_ack
    :initarg :max_track_ack
    :type cl:fixnum
    :initform 0)
   (overheat_error
   ...
   (raw_data_mode
    ...
    :initform cl:nil)
   (steer_angle_ack
    :reader steer_angle_ack
    :initarg :steer_angle_ack
    :type cl:fixnum
    :initform 0)
   (temperature
    :reader temperature
    ...
    :initform 0)
   (spd_comp_factor
    :reader spd_comp_factor
    :initarg :spd_comp_factor
    :type cl:float
    :initform 0.0)
   (grouping_mode
...
(cl:ensure-generic-function 'rolling_count2-val :lambda-list '(m))
(cl:defmethod rolling_count2-val ((m <EsrStatus2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:rolling_count2-val is deprecated.  Use delphi_esr_msgs-msg:rolling_count2 instead.")
  (rolling_count2 m))

(cl:ensure-generic-function 'max_track_ack-val :lambda-list '(m))
(cl:defmethod max_track_ack-val ((m <EsrStatus2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:max_track_ack-val is deprecated.  Use delphi_esr_msgs-msg:max_track_ack instead.")
  (max_track_ack m))
...
(cl:ensure-generic-function 'steer_angle_ack-val :lambda-list '(m))
(cl:defmethod steer_angle_ack-val ((m <EsrStatus2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:steer_angle_ack-val is deprecated.  Use delphi_esr_msgs-msg:steer_angle_ack instead.")
  (steer_angle_ack m))
...
(cl:ensure-generic-function 'spd_comp_factor-val :lambda-list '(m))
(cl:defmethod spd_comp_factor-val ((m <EsrStatus2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:spd_comp_factor-val is deprecated.  Use delphi_esr_msgs-msg:spd_comp_factor instead.")
  (spd_comp_factor m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EsrStatus2>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'rolling_count2)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'max_track_ack)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'steer_angle_ack)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'steer_angle_ack)) ostream)
  (cl:let* ((signed (cl:slot-value msg 'temperature)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    )
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'spd_comp_factor))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EsrStatus2>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'rolling_count2)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'max_track_ack)) (cl:read-byte istream))
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'steer_angle_ack)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'steer_angle_ack)) (cl:read-byte istream))
    (cl:let ((unsigned 0))
    ...
    (cl:setf (cl:slot-value msg 'spd_comp_factor) (roslisp-utils:decode-single-float-bits bits)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EsrStatus2>)))
  ...
  "de9d4dcad18be0f8d7fd839abd77cb7c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EsrStatus2)))
  "Returns md5sum for a message object of type 'EsrStatus2"
  "de9d4dcad18be0f8d7fd839abd77cb7c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsrStatus2>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR status2~%string      canmsg~%uint8       rolling_count2~%uint8       max_track_ack~%bool        overheat_error~%bool        range_perf_error~%bool        internal_error~%bool        xcvr_operational~%bool        raw_data_mode~%uint16      steer_angle_ack~%int8        temperature~%float32     spd_comp_factor~%uint8       grouping_mode~%float32     yaw_rate_bias~%string      sw_version_dsp~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsrStatus2)))
  "Returns full string definition for message of type 'EsrStatus2"
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR status2~%string      canmsg~%uint8       rolling_count2~%uint8       max_track_ack~%bool        overheat_error~%bool        range_perf_error~%bool        internal_error~%bool        xcvr_operational~%bool        raw_data_mode~%uint16      steer_angle_ack~%int8        temperature~%float32     spd_comp_factor~%uint8       grouping_mode~%float32     yaw_rate_bias~%string      sw_version_dsp~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EsrStatus2>))
  ...
  (cl:list 'EsrStatus2
    ...
    (cl:cons ':rolling_count2 (rolling_count2 msg))
    (cl:cons ':max_track_ack (max_track_ack msg))
    ...
    (cl:cons ':steer_angle_ack (steer_angle_ack msg))
    (cl:cons ':temperature (temperature msg))
    (cl:cons ':spd_comp_factor (spd_comp_factor msg))
