...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsrVehicle3>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR vehicle3~%bool        long_accel_valid~%bool        lat_accel_valid~%float32     lat_accel~%float32     long_accel~%uint8       radar_fov_lr~%uint8       radar_fov_mr~%bool        auto_align_disable~%uint8       radar_height~%bool        serv_align_type~%bool        serv_align_enable~%uint16      align_avg_ctr_total~%bool        auto_align_converged~%uint8       wheel_slip~%uint8       serv_align_updates_need~%int8        angle_mounting_offset~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsrVehicle3)))
  "Returns full string definition for message of type 'EsrVehicle3"
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR vehicle3~%bool        long_accel_valid~%bool        lat_accel_valid~%float32     lat_accel~%float32     long_accel~%uint8       radar_fov_lr~%uint8       radar_fov_mr~%bool        auto_align_disable~%uint8       radar_height~%bool        serv_align_type~%bool        serv_align_enable~%uint16      align_avg_ctr_total~%bool        auto_align_converged~%uint8       wheel_slip~%uint8       serv_align_updates_need~%int8        angle_mounting_offset~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
