...
class EsrStatus9 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.side_slip_angle = null;
      this.serial_num3rd_byte = null;
      this.water_spray_target_id = null;
      this.filtered_xohp_acc_cipv = null;
      this.path_id_acc2 = null;
      this.path_id_acc3 = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('side_slip_angle')) {
        this.side_slip_angle = initObj.side_slip_angle
      }
      else {
        this.side_slip_angle = 0.0;
      }
      if (initObj.hasOwnProperty('serial_num3rd_byte')) {
        this.serial_num3rd_byte = initObj.serial_num3rd_byte
      }
      else {
        this.serial_num3rd_byte = 0;
      }
      ...
      if (initObj.hasOwnProperty('path_id_acc2')) {
        this.path_id_acc2 = initObj.path_id_acc2
      }
      else {
        this.path_id_acc2 = 0;
      }
      if (initObj.hasOwnProperty('path_id_acc3')) {
        this.path_id_acc3 = initObj.path_id_acc3
      }
      else {
        this.path_id_acc3 = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [side_slip_angle]
    bufferOffset = _serializer.float32(obj.side_slip_angle, buffer, bufferOffset);
    // Serialize message field [serial_num3rd_byte]
    bufferOffset = _serializer.uint8(obj.serial_num3rd_byte, buffer, bufferOffset);
    ...
    // Serialize message field [path_id_acc2]
    bufferOffset = _serializer.uint8(obj.path_id_acc2, buffer, bufferOffset);
    // Serialize message field [path_id_acc3]
    bufferOffset = _serializer.uint8(obj.path_id_acc3, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [side_slip_angle]
    data.side_slip_angle = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [serial_num3rd_byte]
    data.serial_num3rd_byte = _deserializer.uint8(buffer, bufferOffset);
    ...
    // Deserialize message field [path_id_acc2]
    data.path_id_acc2 = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [path_id_acc3]
    data.path_id_acc3 = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '5b168b544c1d619478bacb46ee366ea7';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.side_slip_angle !== undefined) {
      resolved.side_slip_angle = msg.side_slip_angle;
    }
    else {
      resolved.side_slip_angle = 0.0
    }

    if (msg.serial_num3rd_byte !== undefined) {
      resolved.serial_num3rd_byte = msg.serial_num3rd_byte;
    }
    else {
      resolved.serial_num3rd_byte = 0
    }
    ...
    if (msg.path_id_acc2 !== undefined) {
      resolved.path_id_acc2 = msg.path_id_acc2;
    }
    else {
      resolved.path_id_acc2 = 0
    }

    if (msg.path_id_acc3 !== undefined) {
      resolved.path_id_acc3 = msg.path_id_acc3;
    }
    else {
      resolved.path_id_acc3 = 0
    }
