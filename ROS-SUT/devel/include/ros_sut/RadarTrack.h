// Generated by gencpp from file ros_sut/RadarTrack.msg
// DO NOT EDIT!


#ifndef ROS_SUT_MESSAGE_RADARTRACK_H
#define ROS_SUT_MESSAGE_RADARTRACK_H
...
struct RadarTrack_
{
  ...
  typedef boost::shared_ptr< ::ros_sut::RadarTrack_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ros_sut::RadarTrack_<ContainerAllocator> const> ConstPtr;

}; // struct RadarTrack_

typedef ::ros_sut::RadarTrack_<std::allocator<void> > RadarTrack;

typedef boost::shared_ptr< ::ros_sut::RadarTrack > RadarTrackPtr;
typedef boost::shared_ptr< ::ros_sut::RadarTrack const> RadarTrackConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ros_sut::RadarTrack_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ros_sut::RadarTrack_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ros_sut::RadarTrack_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ros_sut::RadarTrack_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_sut::RadarTrack_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_sut::RadarTrack_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_sut::RadarTrack_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_sut::RadarTrack_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ros_sut::RadarTrack_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ros_sut::RadarTrack_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x371627dd284ddde5ULL;
  static const uint64_t static_value2 = 0x489009ee4498d083ULL;
};

template<class ContainerAllocator>
struct DataType< ::ros_sut::RadarTrack_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ros_sut/RadarTrack";
  }
...
template<class ContainerAllocator>
struct Definition< ::ros_sut::RadarTrack_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ros_sut::RadarTrack_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ros_sut::RadarTrack_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ros_sut::RadarTrack_<ContainerAllocator>& v)
  {
    s << indent << "track_id: ";
...
#endif // ROS_SUT_MESSAGE_RADARTRACK_H
