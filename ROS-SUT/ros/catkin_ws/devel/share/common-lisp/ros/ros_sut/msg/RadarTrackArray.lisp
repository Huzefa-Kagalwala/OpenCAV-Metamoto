...
(cl:defclass <RadarTrackArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (tracks
    :reader tracks
    :initarg :tracks
    :type (cl:vector ros_sut-msg:RadarTrack)
   :initform (cl:make-array 0 :element-type 'ros_sut-msg:RadarTrack :initial-element (cl:make-instance 'ros_sut-msg:RadarTrack))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <RadarTrackArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RadarTrackArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_sut-msg:<RadarTrackArray> is deprecated: use ros_sut-msg:RadarTrackArray instead.")))
...
(cl:defmethod tracks-val ((m <RadarTrackArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_sut-msg:tracks-val is deprecated.  Use ros_sut-msg:tracks instead.")
  (tracks m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RadarTrackArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tracks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ros_sut-msg:RadarTrack))
