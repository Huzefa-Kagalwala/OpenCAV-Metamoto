...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EsrTrack>)))
  ...
  "67d29dbcdfb86efe0822e360bf7a498a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EsrTrack)))
  "Returns md5sum for a message object of type 'EsrTrack"
  "67d29dbcdfb86efe0822e360bf7a498a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsrTrack>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Track Msg~%string        canmsg~%uint8         track_id~%float32       track_lat_rate~%bool          track_group_changed~%uint8         track_status~%float32       track_angle~%float32       track_range~%bool          track_bridge_object~%bool          track_rolling_count~%float32       track_width~%float32       track_range_accel~%uint8         track_med_range_mode~%float32       track_range_rate~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsrTrack)))
  "Returns full string definition for message of type 'EsrTrack"
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Track Msg~%string        canmsg~%uint8         track_id~%float32       track_lat_rate~%bool          track_group_changed~%uint8         track_status~%float32       track_angle~%float32       track_range~%bool          track_bridge_object~%bool          track_rolling_count~%float32       track_width~%float32       track_range_accel~%uint8         track_med_range_mode~%float32       track_range_rate~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
