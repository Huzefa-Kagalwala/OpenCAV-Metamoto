...
(cl:defclass <EsrVehicle4> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (fac_align_cmd1
    :reader fac_align_cmd1
    :initarg :fac_align_cmd1
    :type cl:boolean
    :initform cl:nil)
   (fac_align_cmd2
    :reader fac_align_cmd2
    :initarg :fac_align_cmd2
    :type cl:boolean
    :initform cl:nil)
   (fac_align_max_nt
   ...
   (fac_tgt_mtg_space_ver
    ...
    :initform 0)
   (fac_tgt_range1
    :reader fac_tgt_range1
    :initarg :fac_tgt_range1
    :type cl:float
    :initform 0.0)
   (fac_tgt_range_r2m
...
(cl:ensure-generic-function 'fac_align_cmd1-val :lambda-list '(m))
(cl:defmethod fac_align_cmd1-val ((m <EsrVehicle4>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:fac_align_cmd1-val is deprecated.  Use delphi_esr_msgs-msg:fac_align_cmd1 instead.")
  (fac_align_cmd1 m))

(cl:ensure-generic-function 'fac_align_cmd2-val :lambda-list '(m))
(cl:defmethod fac_align_cmd2-val ((m <EsrVehicle4>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:fac_align_cmd2-val is deprecated.  Use delphi_esr_msgs-msg:fac_align_cmd2 instead.")
  (fac_align_cmd2 m))
...
(cl:ensure-generic-function 'fac_tgt_range1-val :lambda-list '(m))
(cl:defmethod fac_tgt_range1-val ((m <EsrVehicle4>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:fac_tgt_range1-val is deprecated.  Use delphi_esr_msgs-msg:fac_tgt_range1 instead.")
  (fac_tgt_range1 m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EsrVehicle4>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'fac_align_cmd1) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'fac_align_cmd2) 1 0)) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'fac_tgt_range1))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EsrVehicle4>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    (cl:setf (cl:slot-value msg 'fac_align_cmd1) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'fac_align_cmd2) (cl:not (cl:zerop (cl:read-byte istream))))
    ...
    (cl:setf (cl:slot-value msg 'fac_tgt_range1) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EsrVehicle4>)))
  ...
  "e5ad11954543105650efb5580bfa282c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EsrVehicle4)))
  "Returns md5sum for a message object of type 'EsrVehicle4"
  "e5ad11954543105650efb5580bfa282c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsrVehicle4>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR vehicle4~%bool        fac_align_cmd1~%bool        fac_align_cmd2~%uint8       fac_align_max_nt~%uint8       fac_align_samp_req~%int8        fac_tgt_mtg_offset~%int8        fac_tgt_mtg_space_hor~%int8        fac_tgt_mtg_space_ver~%float32     fac_tgt_range1~%float32     fac_tgt_range_r2m~%float32     fac_tgt_range_m2t~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsrVehicle4)))
  "Returns full string definition for message of type 'EsrVehicle4"
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR vehicle4~%bool        fac_align_cmd1~%bool        fac_align_cmd2~%uint8       fac_align_max_nt~%uint8       fac_align_samp_req~%int8        fac_tgt_mtg_offset~%int8        fac_tgt_mtg_space_hor~%int8        fac_tgt_mtg_space_ver~%float32     fac_tgt_range1~%float32     fac_tgt_range_r2m~%float32     fac_tgt_range_m2t~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EsrVehicle4>))
  ...
  (cl:list 'EsrVehicle4
    ...
    (cl:cons ':fac_align_cmd1 (fac_align_cmd1 msg))
    (cl:cons ':fac_align_cmd2 (fac_align_cmd2 msg))
    ...
    (cl:cons ':fac_tgt_range1 (fac_tgt_range1 msg))
