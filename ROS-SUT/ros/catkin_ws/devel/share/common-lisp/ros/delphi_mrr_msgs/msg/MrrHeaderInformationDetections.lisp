...
(cl:defclass <MrrHeaderInformationDetections> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (can_align_uodates_done
    :reader can_align_uodates_done
    :initarg :can_align_uodates_done
    :type cl:fixnum
    :initform 0)
   (can_scan_index
...
(cl:ensure-generic-function 'can_align_uodates_done-val :lambda-list '(m))
(cl:defmethod can_align_uodates_done-val ((m <MrrHeaderInformationDetections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_mrr_msgs-msg:can_align_uodates_done-val is deprecated.  Use delphi_mrr_msgs-msg:can_align_uodates_done instead.")
  (can_align_uodates_done m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MrrHeaderInformationDetections>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'can_align_uodates_done)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'can_align_uodates_done)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MrrHeaderInformationDetections>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'can_align_uodates_done)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'can_align_uodates_done)) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MrrHeaderInformationDetections>)))
  ...
  "09a4495acf78e941c7b228312aac90b7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MrrHeaderInformationDetections)))
  "Returns md5sum for a message object of type 'MrrHeaderInformationDetections"
  "09a4495acf78e941c7b228312aac90b7")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MrrHeaderInformationDetections>))
  ...
  (cl:list 'MrrHeaderInformationDetections
    ...
    (cl:cons ':can_align_uodates_done (can_align_uodates_done msg))
