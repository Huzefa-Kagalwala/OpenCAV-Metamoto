...
class EsrVehicle4 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.header = null;
      this.fac_align_cmd1 = null;
      this.fac_align_cmd2 = null;
      ...
      if (initObj.hasOwnProperty('fac_align_cmd1')) {
        this.fac_align_cmd1 = initObj.fac_align_cmd1
      }
      else {
        this.fac_align_cmd1 = false;
      }
      if (initObj.hasOwnProperty('fac_align_cmd2')) {
        this.fac_align_cmd2 = initObj.fac_align_cmd2
      }
      else {
        this.fac_align_cmd2 = false;
      }
      ...
      if (initObj.hasOwnProperty('fac_tgt_range1')) {
        this.fac_tgt_range1 = initObj.fac_tgt_range1
      }
      else {
        this.fac_tgt_range1 = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [fac_align_cmd1]
    bufferOffset = _serializer.bool(obj.fac_align_cmd1, buffer, bufferOffset);
    // Serialize message field [fac_align_cmd2]
    bufferOffset = _serializer.bool(obj.fac_align_cmd2, buffer, bufferOffset);
    ...
    // Serialize message field [fac_tgt_range1]
    bufferOffset = _serializer.float32(obj.fac_tgt_range1, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [fac_align_cmd1]
    data.fac_align_cmd1 = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [fac_align_cmd2]
    data.fac_align_cmd2 = _deserializer.bool(buffer, bufferOffset);
    ...
    // Deserialize message field [fac_tgt_range1]
    data.fac_tgt_range1 = _deserializer.float32(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'e5ad11954543105650efb5580bfa282c';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.fac_align_cmd1 !== undefined) {
      resolved.fac_align_cmd1 = msg.fac_align_cmd1;
    }
    else {
      resolved.fac_align_cmd1 = false
    }

    if (msg.fac_align_cmd2 !== undefined) {
      resolved.fac_align_cmd2 = msg.fac_align_cmd2;
    }
    else {
      resolved.fac_align_cmd2 = false
    }
    ...
    if (msg.fac_tgt_range1 !== undefined) {
      resolved.fac_tgt_range1 = msg.fac_tgt_range1;
    }
    else {
      resolved.fac_tgt_range1 = 0.0
    }
