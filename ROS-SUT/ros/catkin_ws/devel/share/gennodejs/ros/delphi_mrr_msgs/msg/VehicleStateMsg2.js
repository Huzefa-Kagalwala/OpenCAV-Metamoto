...
class VehicleStateMsg2 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.can_vehicle_index4fa = null;
      ...
      if (initObj.hasOwnProperty('can_vehicle_index4fa')) {
        this.can_vehicle_index4fa = initObj.can_vehicle_index4fa
      }
      else {
        this.can_vehicle_index4fa = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [can_vehicle_index4fa]
    bufferOffset = _serializer.uint16(obj.can_vehicle_index4fa, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.uint16(obj.can_steering_whl_angle, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [can_vehicle_index4fa]
    data.can_vehicle_index4fa = _deserializer.uint16(buffer, bufferOffset);
    ...
    data.can_steering_whl_angle = _deserializer.uint16(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.can_vehicle_index4fa !== undefined) {
      resolved.can_vehicle_index4fa = msg.can_vehicle_index4fa;
    }
    else {
      resolved.can_vehicle_index4fa = 0
    }
    ...
    if (msg.can_steering_whl_angle !== undefined) {
      ...
      resolved.can_steering_whl_angle = 0
    }
