...
class ActiveFaultLatched2 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.carcfg_not_configured_error = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('carcfg_not_configured_error')) {
        this.carcfg_not_configured_error = initObj.carcfg_not_configured_error
      }
      else {
        this.carcfg_not_configured_error = false;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [carcfg_not_configured_error]
    bufferOffset = _serializer.bool(obj.carcfg_not_configured_error, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [carcfg_not_configured_error]
    data.carcfg_not_configured_error = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.carcfg_not_configured_error !== undefined) {
      resolved.carcfg_not_configured_error = msg.carcfg_not_configured_error;
    }
    else {
      resolved.carcfg_not_configured_error = false
    }
