...
struct EsrVehicle4_
{
  ...
  EsrVehicle4_()
    : header()
    , fac_align_cmd1(false)
    , fac_align_cmd2(false)
    , fac_align_max_nt(0)
  ...
  _header_type header;
   ...
   typedef uint8_t _fac_align_cmd1_type;
  _fac_align_cmd1_type fac_align_cmd1;

   typedef uint8_t _fac_align_cmd2_type;
  _fac_align_cmd2_type fac_align_cmd2;
  ...
  _fac_tgt_mtg_space_ver_type fac_tgt_mtg_space_ver;
   ...
   typedef float _fac_tgt_range1_type;
  _fac_tgt_range1_type fac_tgt_range1;
...
struct MD5Sum< ::delphi_esr_msgs::EsrVehicle4_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xe5ad119545431056ULL;
  static const uint64_t static_value2 = 0x50efb5580bfa282cULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::delphi_esr_msgs::EsrVehicle4_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.fac_align_cmd1);
      stream.next(m.fac_align_cmd2);
...
struct Printer< ::delphi_esr_msgs::EsrVehicle4_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::delphi_esr_msgs::EsrVehicle4_<ContainerAllocator>& v)
  {
    ...
    s << indent << "fac_align_cmd1: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.fac_align_cmd1);
    s << indent << "fac_align_cmd2: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.fac_align_cmd2);
    ...
    s << indent << "fac_tgt_range1: ";
    Printer<float>::stream(s, indent + "  ", v.fac_tgt_range1);
