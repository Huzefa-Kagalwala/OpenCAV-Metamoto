...
class MrrStatusSerialNumber {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.can_serial_number, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.can_serial_number = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '393ac814c9f7793e6ea633966013ddd8';
  }
