...
class MrrHeaderInformationDetections {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.header = null;
      this.can_align_uodates_done = null;
      ...
      if (initObj.hasOwnProperty('can_align_uodates_done')) {
        this.can_align_uodates_done = initObj.can_align_uodates_done
      }
      else {
        this.can_align_uodates_done = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [can_align_uodates_done]
    bufferOffset = _serializer.uint16(obj.can_align_uodates_done, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [can_align_uodates_done]
    data.can_align_uodates_done = _deserializer.uint16(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.can_align_uodates_done !== undefined) {
      resolved.can_align_uodates_done = msg.can_align_uodates_done;
    }
    else {
      resolved.can_align_uodates_done = 0
    }
