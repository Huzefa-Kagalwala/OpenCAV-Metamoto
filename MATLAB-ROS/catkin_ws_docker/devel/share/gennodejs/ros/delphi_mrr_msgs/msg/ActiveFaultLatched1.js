...
class ActiveFaultLatched1 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.vertical_alignment_outof_range = null;
      this.horizontal_alignment_outof_range = null;
      this.factory_alignment_mode = null;
      this.battery_low_fault = null;
      this.battery_high_fault = null;
      this.v1_p25_supply_outof_range = null;
      this.active_flt_latched_byte3_bit4 = null;
      this.thermistor_outof_range = null;
      this.v3_p3_dac_supply_outof_range = null;
      this.v3_p3_raw_supply_outof_range = null;
      this.v5_supply_outof_range = null;
      ...
      if (initObj.hasOwnProperty('loop_bw_outof_range')) {
        this.loop_bw_outof_range = initObj.loop_bw_outof_range
      }
      else {
        this.loop_bw_outof_range = false;
      }
      ...
      if (initObj.hasOwnProperty('vertical_alignment_outof_range')) {
        this.vertical_alignment_outof_range = initObj.vertical_alignment_outof_range
      }
      else {
        this.vertical_alignment_outof_range = false;
      }
      if (initObj.hasOwnProperty('horizontal_alignment_outof_range')) {
        this.horizontal_alignment_outof_range = initObj.horizontal_alignment_outof_range
      }
      else {
        this.horizontal_alignment_outof_range = false;
      }
      ...
      if (initObj.hasOwnProperty('v1_p25_supply_outof_range')) {
        this.v1_p25_supply_outof_range = initObj.v1_p25_supply_outof_range
      }
      else {
        this.v1_p25_supply_outof_range = false;
      }
      ...
      if (initObj.hasOwnProperty('thermistor_outof_range')) {
        this.thermistor_outof_range = initObj.thermistor_outof_range
      }
      else {
        this.thermistor_outof_range = false;
      }
      if (initObj.hasOwnProperty('v3_p3_dac_supply_outof_range')) {
        this.v3_p3_dac_supply_outof_range = initObj.v3_p3_dac_supply_outof_range
      }
      else {
        this.v3_p3_dac_supply_outof_range = false;
      }
      if (initObj.hasOwnProperty('v3_p3_raw_supply_outof_range')) {
        this.v3_p3_raw_supply_outof_range = initObj.v3_p3_raw_supply_outof_range
      }
      else {
        this.v3_p3_raw_supply_outof_range = false;
      }
      if (initObj.hasOwnProperty('v5_supply_outof_range')) {
        this.v5_supply_outof_range = initObj.v5_supply_outof_range
      }
      else {
        this.v5_supply_outof_range = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [loop_bw_outof_range]
    bufferOffset = _serializer.bool(obj.loop_bw_outof_range, buffer, bufferOffset);
    ...
    // Serialize message field [vertical_alignment_outof_range]
    bufferOffset = _serializer.bool(obj.vertical_alignment_outof_range, buffer, bufferOffset);
    // Serialize message field [horizontal_alignment_outof_range]
    bufferOffset = _serializer.bool(obj.horizontal_alignment_outof_range, buffer, bufferOffset);
    ...
    // Serialize message field [v1_p25_supply_outof_range]
    bufferOffset = _serializer.bool(obj.v1_p25_supply_outof_range, buffer, bufferOffset);
    ...
    // Serialize message field [thermistor_outof_range]
    bufferOffset = _serializer.bool(obj.thermistor_outof_range, buffer, bufferOffset);
    // Serialize message field [v3_p3_dac_supply_outof_range]
    bufferOffset = _serializer.bool(obj.v3_p3_dac_supply_outof_range, buffer, bufferOffset);
    // Serialize message field [v3_p3_raw_supply_outof_range]
    bufferOffset = _serializer.bool(obj.v3_p3_raw_supply_outof_range, buffer, bufferOffset);
    // Serialize message field [v5_supply_outof_range]
    bufferOffset = _serializer.bool(obj.v5_supply_outof_range, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [loop_bw_outof_range]
    data.loop_bw_outof_range = _deserializer.bool(buffer, bufferOffset);
    ...
    // Deserialize message field [vertical_alignment_outof_range]
    data.vertical_alignment_outof_range = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [horizontal_alignment_outof_range]
    data.horizontal_alignment_outof_range = _deserializer.bool(buffer, bufferOffset);
    ...
    // Deserialize message field [v1_p25_supply_outof_range]
    data.v1_p25_supply_outof_range = _deserializer.bool(buffer, bufferOffset);
    ...
    // Deserialize message field [thermistor_outof_range]
    data.thermistor_outof_range = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [v3_p3_dac_supply_outof_range]
    data.v3_p3_dac_supply_outof_range = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [v3_p3_raw_supply_outof_range]
    data.v3_p3_raw_supply_outof_range = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [v5_supply_outof_range]
    data.v5_supply_outof_range = _deserializer.bool(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.loop_bw_outof_range !== undefined) {
      resolved.loop_bw_outof_range = msg.loop_bw_outof_range;
    }
    else {
      resolved.loop_bw_outof_range = false
    }
    ...
    if (msg.vertical_alignment_outof_range !== undefined) {
      resolved.vertical_alignment_outof_range = msg.vertical_alignment_outof_range;
    }
    else {
      resolved.vertical_alignment_outof_range = false
    }

    if (msg.horizontal_alignment_outof_range !== undefined) {
      resolved.horizontal_alignment_outof_range = msg.horizontal_alignment_outof_range;
    }
    else {
      resolved.horizontal_alignment_outof_range = false
    }
    ...
    if (msg.v1_p25_supply_outof_range !== undefined) {
      resolved.v1_p25_supply_outof_range = msg.v1_p25_supply_outof_range;
    }
    else {
      resolved.v1_p25_supply_outof_range = false
    }
    ...
    if (msg.thermistor_outof_range !== undefined) {
      resolved.thermistor_outof_range = msg.thermistor_outof_range;
    }
    else {
      resolved.thermistor_outof_range = false
    }

    if (msg.v3_p3_dac_supply_outof_range !== undefined) {
      resolved.v3_p3_dac_supply_outof_range = msg.v3_p3_dac_supply_outof_range;
    }
    else {
      resolved.v3_p3_dac_supply_outof_range = false
    }

    if (msg.v3_p3_raw_supply_outof_range !== undefined) {
      resolved.v3_p3_raw_supply_outof_range = msg.v3_p3_raw_supply_outof_range;
    }
    else {
      resolved.v3_p3_raw_supply_outof_range = false
    }

    if (msg.v5_supply_outof_range !== undefined) {
      resolved.v5_supply_outof_range = msg.v5_supply_outof_range;
    }
    else {
      resolved.v5_supply_outof_range = false
    }
