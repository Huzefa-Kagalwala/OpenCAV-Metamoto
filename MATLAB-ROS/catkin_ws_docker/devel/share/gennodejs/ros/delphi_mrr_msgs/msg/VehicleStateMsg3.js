...
class VehicleStateMsg3 {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint16(obj.yaw_rate_reference, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.uint16(obj.can_veh_long_accel, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.yaw_rate_reference = _deserializer.uint16(buffer, bufferOffset);
    ...
    data.can_veh_long_accel = _deserializer.uint16(buffer, bufferOffset);
    return data;
  }
