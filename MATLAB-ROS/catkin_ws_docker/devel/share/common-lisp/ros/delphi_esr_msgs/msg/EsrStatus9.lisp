...
(cl:defclass <EsrStatus9> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (avg_pwr_cwblkg
    ...
    :initform 0)
   (side_slip_angle
    :reader side_slip_angle
    :initarg :side_slip_angle
    :type cl:float
    :initform 0.0)
   (serial_num3rd_byte
    :reader serial_num3rd_byte
    :initarg :serial_num3rd_byte
    :type cl:fixnum
    :initform 0)
   ...
   (path_id_acc2
    :reader path_id_acc2
    :initarg :path_id_acc2
    :type cl:fixnum
    :initform 0)
   (path_id_acc3
    :reader path_id_acc3
    :initarg :path_id_acc3
    :type cl:fixnum
    :initform 0))
)
...
(cl:ensure-generic-function 'side_slip_angle-val :lambda-list '(m))
(cl:defmethod side_slip_angle-val ((m <EsrStatus9>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:side_slip_angle-val is deprecated.  Use delphi_esr_msgs-msg:side_slip_angle instead.")
  (side_slip_angle m))

(cl:ensure-generic-function 'serial_num3rd_byte-val :lambda-list '(m))
(cl:defmethod serial_num3rd_byte-val ((m <EsrStatus9>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:serial_num3rd_byte-val is deprecated.  Use delphi_esr_msgs-msg:serial_num3rd_byte instead.")
  (serial_num3rd_byte m))
...
(cl:ensure-generic-function 'path_id_acc2-val :lambda-list '(m))
(cl:defmethod path_id_acc2-val ((m <EsrStatus9>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:path_id_acc2-val is deprecated.  Use delphi_esr_msgs-msg:path_id_acc2 instead.")
  (path_id_acc2 m))

(cl:ensure-generic-function 'path_id_acc3-val :lambda-list '(m))
(cl:defmethod path_id_acc3-val ((m <EsrStatus9>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:path_id_acc3-val is deprecated.  Use delphi_esr_msgs-msg:path_id_acc3 instead.")
  (path_id_acc3 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EsrStatus9>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'side_slip_angle))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'serial_num3rd_byte)) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'filtered_xohp_acc_cipv))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'path_id_acc2)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'path_id_acc3)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EsrStatus9>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:setf (cl:slot-value msg 'side_slip_angle) (roslisp-utils:decode-single-float-bits bits)))
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'serial_num3rd_byte)) (cl:read-byte istream))
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'path_id_acc2)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'path_id_acc3)) (cl:read-byte istream))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EsrStatus9>)))
  ...
  "5b168b544c1d619478bacb46ee366ea7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EsrStatus9)))
  "Returns md5sum for a message object of type 'EsrStatus9"
  "5b168b544c1d619478bacb46ee366ea7")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsrStatus9>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR status9~%string      canmsg~%uint16      avg_pwr_cwblkg~%float32     side_slip_angle~%uint8       serial_num3rd_byte~%uint8       water_spray_target_id~%float32     filtered_xohp_acc_cipv~%uint8       path_id_acc2~%uint8       path_id_acc3~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsrStatus9)))
  "Returns full string definition for message of type 'EsrStatus9"
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR status9~%string      canmsg~%uint16      avg_pwr_cwblkg~%float32     side_slip_angle~%uint8       serial_num3rd_byte~%uint8       water_spray_target_id~%float32     filtered_xohp_acc_cipv~%uint8       path_id_acc2~%uint8       path_id_acc3~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EsrStatus9>))
  ...
  (cl:list 'EsrStatus9
    ...
    (cl:cons ':side_slip_angle (side_slip_angle msg))
    (cl:cons ':serial_num3rd_byte (serial_num3rd_byte msg))
    (cl:cons ':water_spray_target_id (water_spray_target_id msg))
    (cl:cons ':filtered_xohp_acc_cipv (filtered_xohp_acc_cipv msg))
    (cl:cons ':path_id_acc2 (path_id_acc2 msg))
    (cl:cons ':path_id_acc3 (path_id_acc3 msg))
))
