...
(cl:defclass <ActiveFaultLatched2> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (carcfg_not_configured_error
    :reader carcfg_not_configured_error
    :initarg :carcfg_not_configured_error
    :type cl:boolean
    :initform cl:nil))
)
...
(cl:ensure-generic-function 'carcfg_not_configured_error-val :lambda-list '(m))
(cl:defmethod carcfg_not_configured_error-val ((m <ActiveFaultLatched2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_mrr_msgs-msg:carcfg_not_configured_error-val is deprecated.  Use delphi_mrr_msgs-msg:carcfg_not_configured_error instead.")
  (carcfg_not_configured_error m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ActiveFaultLatched2>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'carcfg_not_configured_error) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ActiveFaultLatched2>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:setf (cl:slot-value msg 'carcfg_not_configured_error) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ActiveFaultLatched2>)))
  ...
  "e4a1d49e118f29fa137daca85b94915c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ActiveFaultLatched2)))
  "Returns md5sum for a message object of type 'ActiveFaultLatched2"
  "e4a1d49e118f29fa137daca85b94915c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ActiveFaultLatched2>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%bool ipma_pcan_data_range_check~%bool ipma_pcan_missing_msg~%bool vin_signal_compare_failure~%bool module_not_configured_error~%bool carcfg_not_configured_error~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ActiveFaultLatched2)))
  "Returns full string definition for message of type 'ActiveFaultLatched2"
  (cl:format cl:nil "std_msgs/Header header~%~%bool ipma_pcan_data_range_check~%bool ipma_pcan_missing_msg~%bool vin_signal_compare_failure~%bool module_not_configured_error~%bool carcfg_not_configured_error~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ActiveFaultLatched2>))
  ...
  (cl:list 'ActiveFaultLatched2
    ...
    (cl:cons ':carcfg_not_configured_error (carcfg_not_configured_error msg))
))
