...
(cl:defclass <VehicleStateMsg2> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (can_vehicle_index4fa
    :reader can_vehicle_index4fa
    :initarg :can_vehicle_index4fa
    :type cl:fixnum
    :initform 0)
...
(cl:ensure-generic-function 'can_vehicle_index4fa-val :lambda-list '(m))
(cl:defmethod can_vehicle_index4fa-val ((m <VehicleStateMsg2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_mrr_msgs-msg:can_vehicle_index4fa-val is deprecated.  Use delphi_mrr_msgs-msg:can_vehicle_index4fa instead.")
  (can_vehicle_index4fa m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VehicleStateMsg2>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'can_vehicle_index4fa)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'can_vehicle_index4fa)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'can_steering_whl_angle)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'can_steering_whl_angle)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VehicleStateMsg2>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'can_vehicle_index4fa)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'can_vehicle_index4fa)) (cl:read-byte istream))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'can_steering_whl_angle)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'can_steering_whl_angle)) (cl:read-byte istream))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VehicleStateMsg2>)))
  ...
  "5063ce040d482c3323905bf32060059a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VehicleStateMsg2)))
  "Returns md5sum for a message object of type 'VehicleStateMsg2"
  "5063ce040d482c3323905bf32060059a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VehicleStateMsg2>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%bool    fsm_yaw_rate_valid~%float32 fsm_yaw_rate~%uint16  can_vehicle_index4fa~%float32 fsm_vehicle_velocity~%bool    can_steering_whl_angle_qf~%uint16  can_steering_whl_angle~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VehicleStateMsg2)))
  "Returns full string definition for message of type 'VehicleStateMsg2"
  (cl:format cl:nil "std_msgs/Header header~%~%bool    fsm_yaw_rate_valid~%float32 fsm_yaw_rate~%uint16  can_vehicle_index4fa~%float32 fsm_vehicle_velocity~%bool    can_steering_whl_angle_qf~%uint16  can_steering_whl_angle~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VehicleStateMsg2>))
  ...
  (cl:list 'VehicleStateMsg2
    ...
    (cl:cons ':can_vehicle_index4fa (can_vehicle_index4fa msg))
