...
public:
  ...
  FLOAT static DegToRad(FLOAT deg);

  // RadToDeg
  // Converts radians to degrees.
  FLOAT static RadToDeg(FLOAT rad);
  ...
  FLOAT static ArcLengthOfMeridian(FLOAT phi);
  ...
  FLOAT static UTMCentralMeridian(int zone);
  ...
  FLOAT static FootpointLatitude(FLOAT y);
  ...
  void static MapLatLonToXY(FLOAT phi, FLOAT lambda, FLOAT lambda0, FLOAT &x, FLOAT &y);
  ...
  void static MapXYToLatLon(FLOAT x, FLOAT y, FLOAT lambda0, FLOAT& phi, FLOAT& lambda);
  ...
  int static LatLonToUTMXY(FLOAT lat, FLOAT lon, int zone, FLOAT& x, FLOAT& y);
  ...
  // Returns:
  // The function does not return a value.
  void static UTMXYToLatLon(FLOAT x, FLOAT y, int zone, bool southhemi, FLOAT& lat, FLOAT& lon);
};
